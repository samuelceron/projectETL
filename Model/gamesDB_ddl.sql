...
CREATE TABLE "Game_Category" (
    "app_id" int   NOT NULL,
    "category_id" int   NOT NULL,
    CONSTRAINT "pk_Game_Category" PRIMARY KEY (
        "app_id","category_id"
     )
);
...
ALTER TABLE "Game_Category" ADD CONSTRAINT "fk_Game_Category_app_id" FOREIGN KEY("app_id")
REFERENCES "Games" ("app_id");

ALTER TABLE "Game_Category" ADD CONSTRAINT "fk_Game_Category_category_id" FOREIGN KEY("category_id")
